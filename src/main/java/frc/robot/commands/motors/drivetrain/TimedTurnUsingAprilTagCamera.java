...
/**
 * This command is a timed version of the TurnUsingAprilTagCamera command, which will automatically stop after a specified timeout
 * to prevent the robot from getting stuck in this command indefinitely if it cannot reach the target for some reason
 * (e.g. target is lost, camera malfunction, etc.).
 */
public class TimedTurnUsingAprilTagCamera extends WaitCommand {
	...
	public TimedTurnUsingAprilTagCamera(SwerveDrivetrain drivetrain, PhotonVision.PhotonVisionEstimationSubsystem camera, double timeout) {
		super(timeout);
	...
	public void initialize() {
		System.out.println("TimedTurnUsingCamera: initialize");
		super.initialize();
	...
	public void end(boolean interrupted) {
		System.out.println("TimedTurnUsingCamera: end");
		drivetrain.stop();
